...
define(['./workbox-3bd3c2d6'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url
  }) => url.pathname.startsWith("/api") || url.pathname.startsWith("/sanctum") || /\/api(?:\/|$)/.test(url.pathname), new workbox.NetworkOnly({
