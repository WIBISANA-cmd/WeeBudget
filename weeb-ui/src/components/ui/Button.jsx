...
const Button = forwardRef(({ 
  ...
  const variants = {
    ...
    secondary: "bg-white text-text-body border border-border-subtle hover:border-primary-500 hover:bg-primary-500/5 hover:text-primary-600",
    outline: "border border-border-strong bg-white text-primary-600 hover:bg-primary-500/5",
    ghost: "bg-transparent text-primary-600 hover:bg-primary-500/10",
    danger: "bg-danger-base text-white hover:bg-danger-base/90 shadow-sm shadow-danger-base/20",
  };
